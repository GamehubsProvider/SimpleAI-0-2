    ...
    public static async Task Main(string[] args) // Heart Of The program
    {
        ...
        {   
            ...
            else if (inputToData.Contains("AI, Lets play rock paper scissors", StringComparison.OrdinalIgnoreCase))
            {
                ...
                Query.GamePaper();
            } else if(inputToData.Contains("Remember My Password")) {
         ...
         "a","apple","Fell","Down","From","A","tree","Aka","The","Big","Ball","My","Gender","Is","Male","AI","Is","Good","Dunked","On"
            ...
            else if (inputToData.Contains("Read All Of Your file content", StringComparison.OrdinalIgnoreCase))
            {
                string[] content = File.ReadAllLines("main.cs");
                Console.WriteLine(content);

            }
            else if (inputToData.Contains("Format My Gmail", StringComparison.OrdinalIgnoreCase))
            {
                Console.WriteLine("Enter Your Gmail");
                string Gmail = Console.ReadLine();
                Query.GmailFormat();
            }
            else if (inputToData.Contains("I want the length of console to be desired", StringComparison.OrdinalIgnoreCase))
            {
            ...
            else if (inputToData.Contains("Can you provide me with a code snippet of Html?"))
            {
              Query.Snippets(); 
            }
